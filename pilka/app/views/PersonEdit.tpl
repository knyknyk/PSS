...
{block name=bottom}
<form action="{$conf->action_root}personSave" method="post" class="pure-form pure-form-aligned" autocomplete="off">
    <fieldset>
        <legend>Dane osoby</legend>

        <div class="pure-control-group">
            <label for="first_name">Imię</label>
            <input id="first_name" type="text" name="first_name" placeholder="Imię" value="{$form->first_name|escape}">
        </div>

        <div class="pure-control-group">
            <label for="last_name">Nazwisko</label>
            <input id="last_name" type="text" name="last_name" placeholder="Nazwisko" value="{$form->last_name|escape}">
        </div>

        <div class="pure-controls">
            <input type="submit" class="pure-button pure-button-primary" value="Zapisz">
            <a class="button-secondary" href="{$conf->action_root}personList">Powrót</a>
        </div>
    </fieldset>
