...
<div class="bottom-margin">
    <a class="pure-button button-success" href="{$conf->action_root}leagueNew">+ Nowa liga</a>
</div>
...
<div class="table-wrapper">
    <table class="pure-table pure-table-bordered" id="leagueTable">
        ...
        <tbody>
            ...
            <tr>
                <td>{$l["league_name"]}</td>
                <td>{$l["number_of_clubs"]}</td>
                <td>{$l["country"]}</td>
                <td>
                    <a class="button-small pure-button button-secondary" href="{$conf->action_url}leagueEdit/{$l['id_league']}">Edytuj</a>
                    <a class="button-small pure-button button-warning" href="{$conf->action_url}leagueDelete/{$l['id_league']}">Usuń</a>
                </td>
            </tr>
            {/foreach}
        </tbody>
